...
export default function Login() {
  ...
  return (
    ...
    <Text className='mt-4 px-8 text-4xl font-bold '>Create account</Text>
    <Text className=' pl-8 text-lg '>Please sign in to continue </Text>
    <TextInput placeholder=' Username' className="w-80 border bg-slate-100 rounded-xl ml-10 mt-10 px-2 py-3 flex flex-row justify-center border-black" />
    <TextInput placeholder=' Email id' className="w-80 border bg-slate-100 rounded-xl ml-10 mt-10 px-2 py-3 flex flex-row justify-center border-black" />
    ...
    <View >
      <Link href="Login">
        ...
        border-cyan-300 rounded-full border w-32"
          ...
          style={styles.button}>
          <Text className='font-bold text-md text-[#07395c] '>Sign up</Text>
        </LinearGradient>
      </Link>
    </View>
    </TouchableOpacity>
    <View className='flex-1 flex-row justify-center items-end z-[1] mb-10'>
      ...
      <TouchableOpacity>
      <Link href='/'>
      <Text className='font-bold'>Signin</Text>
      </Link>
      </TouchableOpacity>
    </View>
    <Image source={{
